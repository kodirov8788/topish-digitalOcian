    ...
    Jobs: {
        ...
        properties: {
            ...
            benefits: {
                ...
                example: ["Health insurance, Paid time off, Remote work options", "Health insurance, Paid time off, Remote work options 2", "Health insurance, Paid time off, Remote work options 3"]
            },
            location: {
                type: 'string',
                required: true,
    ...
    Office: {
        ...
        properties: {
            ...
            description: {
                ...
                example: "A well-lit and spacious office located in the heart of the city, perfect for startups."
            },
            location: {
                type: "string",
    ...
    Company: {
        ...
        properties: {
            ...
            company_description: {
                ...
                required: true,
                example: "A tech company that specializes in creating innovative solutions."
            },
            company_location: {
                type: "string",
            ...
            company_owner: {
                ...
                required: false,
                example: "5f76d86a7d20c43997890873"
            },
            likedBy: {
                type: "array",
                items: {
        ...
        required: ["company_description", "company_name", "company_location", "company_size", "company_type", "createdBy"]
    }
};
