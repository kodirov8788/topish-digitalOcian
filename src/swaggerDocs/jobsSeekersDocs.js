const JobSeekersEndpoint = {
                        ...
                        'application/json': {
                            schema: {
                                ...
                                properties: {
                                    ...
                                    msg: { type: 'string', example: 'Job seekers retrieved successfully' },
                                    data: {
                                        type: 'array',
    ...
    '/users/getJobseekersSavedjob': {
        get: {
            ...
            tags: ['JobSeekers'],
            description: 'Retrieves saved jobs and quick jobs for the authenticated job seeker. Supports pagination.',
            parameters: [
                {
                    in: 'query',
                    name: 'page',
                    ...
                    content: {
                        'application/json': {
                            schema: {
                                ...
                                properties: {
                                    result: { type: 'string', example: 'error' },
                                    msg: { type: 'string', example: 'Unauthorized or Job Seeker only' },
                                    data: { type: 'null' },
    ...
    "/users/deleteJobseekersSavedjob/{id}": {
        delete: {
            ...
            tags: ["JobSeekers"],
            description: "Allows a job seeker to remove a job from their saved jobs. Requires authentication and verification that the user is a job seeker.",
            parameters: [
                {
                    in: "path",
                    name: "id",
            ...
            responses: {
                "200": {
                    description: "Job application removed successfully from the job seeker's saved jobs.",
                    content: {
                        "application/json": {
                            schema: {
                                type: "object",
                                properties: {
                                    result: { type: "string", example: "success" },
                                    msg: { type: "string", example: "Job application removed successfully." },
                                    data: { type: "null" },
                                    totalCount: { type: "integer", example: 0 },
                                },
                            },
                ...
                "401": {
                    description: "Unauthorized access or operation not allowed for the user's role.",
                    content: {
                        "application/json": {
                            schema: {
                                type: "object",
                                properties: {
                                    result: { type: "string", example: "error" },
                                    msg: { type: "string", example: "Unauthorized or not a Job Seeker." },
                                    data: { type: "null" },
                                    totalCount: { type: "integer", example: 0 },
                                },
                            },
                ...
                "404": {
                    description: "Job not found or job seeker not an applicant for the specified job.",
                    content: {
                        "application/json": {
                            schema: {
                                type: "object",
                                properties: {
                                    result: { type: "string", example: "error" },
                                    msg: { type: "string", example: "Job not found or job seeker not an applicant." },
                                    data: { type: "null" },
                                    totalCount: { type: "integer", example: 0 },
                                },
                            },
