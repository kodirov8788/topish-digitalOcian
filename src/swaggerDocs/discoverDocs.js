const DiscoverEndpoint = {
    ...
    "/discovers/": {
                    ...
                    "multipart/form-data": {
                        schema: {
                            ...
                            properties: {
                                title: {
                                    type: "string",
                                    description: "Title of the discover item in the specified language.",
                                    example: "Discover Samarkand",
                                },
                                description: {
                                    type: "string",
                                    description: "Description of the discover item in the specified language.",
                                ...
                                tags: {
                                    ...
                                    description: "Array of tag IDs referencing DiscoverTag documents.",
                                ...
                                locationImage: {
                                    type: "string",
                                    format: "binary",
                                    description: "Image representing the location for the discover item.",
                                },
                                countryCode: {
                                    type: "string",
                        ...
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    ...
                                    msg: { type: "string", example: "Discover item created successfully." },
                                    data: {
                                        type: "object",
                                        properties: {
                                            id: { type: "string", example: "64f1a5e8764f03b0f7c2a310" },
                                            ...
                                            tags: {
                                                type: "array",
                                                items: { type: "string" },
                                                example: ["64f1a5e8764f03b0f7c2a312", "64f1a5e8764f03b0f7c2a313"],
                                            },
                                            image: {
                                                type: "string",
                        ...
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    ...
                                    msg: { type: "string", example: "At least one tag ID is required." },
                                },
                            },
                        },
                    },
        ...
        get: {
            ...
            tags: ["Discover"],
            description: "Fetches a list of all discover items with optional pagination, sorting, and filtering capabilities.",
            parameters: [
                {
                    name: "page",
                    in: "query",
                ...
                },
                {
                    ...
                    in: "query",
                    required: false,
                    description: "Sort order for items. Use fields like 'createdAt' or '-createdAt' for ascending or descending order.",
                    schema: {
                        type: "string",
                        example: "-createdAt",
                    },
                },
                {
                    ...
                    in: "query",
                    required: false,
                    description: "Filter items by language. Provide a language code (e.g., 'en', 'fr').",
                    schema: {
                        type: "string",
                        example: "en",
                    },
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "success" },
                                    msg: { type: "string", example: "Items retrieved successfully." },
                                    data: {
                                        type: "object",
                                        properties: {
                                            discovers: {
                                                ...
                                                items: {
                                                    ...
                                                    properties: {
                                                        ...
                                                        description: {
                                                            type: "string",
                                                            example: "A breathtaking view of the Rocky Mountains."
                                                        },
                                                        tags: {
                                                            type: "array",
                                                            items: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "error" },
                                    msg: { type: "string", example: "Invalid query parameters provided." },
                                },
                            },
                        },
                    },
    ...
    "/discovers/{id}": {
        get: {
            ...
            responses: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "success" },
                                    msg: { type: "string", example: "Item retrieved successfully." },
                                    data: {
                                        type: "object",
                                        properties: {
                                            id: { type: "string", example: "64f1a5e8764f03b0f7c2a310" },
                                            ...
                                            description: {
                                                type: "string",
                                                example: "Experience the majestic views of the Grand Canyon."
                                            },
                                            tags: {
                                                type: "array",
                                                items: {
                ...
                404: {
                    description: "Not Found - The requested discover item does not exist.",
                    content: {
                        "application/json": {
                            schema: {
                                type: "object",
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "error" },
                                    msg: { type: "string", example: "An error occurred while retrieving the item." },
                                },
                            },
                        },
                    },
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "success" },
                                    msg: { type: "string", example: "Discover item deleted successfully." },
                                },
                            },
                        },
                    },
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "error" },
                                    msg: { type: "string", example: "You are not allowed to delete this item." },
                                },
                            },
                        },
                    },
        ...
        put: {
            ...
            tags: ["Discover"],
            description: "Allows an authenticated user to update a discover item by its unique ID.",
            security: [
                {
                    bearerAuth: [],
                },
                    ...
                    "multipart/form-data": {
                        schema: {
                            ...
                            properties: {
                                title: {
                                    type: "string",
                                    description: "Updated title of the discover item in the specified language.",
                                    example: "Updated Discover Samarkand",
                                },
                                description: {
                                    type: "string",
                                    description: "Updated description of the discover item in the specified language.",
                                    example: "Explore the updated historical beauty of Samarkand.",
                                },
                                tags: {
                                    type: "array",
                                    items: {
                                    ...
                                    description: "Array of updated tag IDs referencing DiscoverTag documents.",
                                    example: ["64f1a5e8764f03b0f7c2a312", "64f1a5e8764f03b0f7c2a313"],
                                },
                                image: {
                                    type: "string",
                                ...
                                locationImage: {
                                    type: "string",
                                    format: "binary",
                                    description: "Updated image representing the location for the discover item.",
                                },
                                countryCode: {
                                    type: "string",
                            ...
                            required: ["title", "description", "tagIds", "countryCode", "language"],
                        },
                    },
                },
            },
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "success" },
                                    msg: { type: "string", example: "Discover item updated successfully." },
                                    data: {
                                        type: "object",
                                        properties: {
                                            id: { type: "string", example: "64f1a5e8764f03b0f7c2a310" },
                                            title: { type: "string", example: "Updated Discover Samarkand" },
                                            description: {
                                                type: "string",
                                                example: "Explore the updated historical beauty of Samarkand.",
                                            },
                                            text: {
                                                type: "string",
                                                example: "Updated: Samarkand is a cultural and historical gem of Central Asia.",
                                            },
                                            tags: {
                                                type: "array",
                                                items: { type: "string" },
                                            ...
                                            locationImage: {
                                                type: "string",
                                                example: "https://example.com/updated-location-image.jpg",
                                            },
                                            countryCode: { type: "string", example: "UZ" },
                                            language: { type: "string", example: "en" },
                                            location: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "error" },
                                    msg: { type: "string", example: "Validation failed for the provided input." },
                                },
                            },
                        },
                    },
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "error" },
                                    msg: { type: "string", example: "An error occurred while updating the item." },
                                },
                            },
                        },
                    },
    ...
    "/discovers/search": {
        get: {
            ...
            tags: ["Discover"],
            description:
                "Search discover items by tags, query, or location. Tags should be passed as text to match against the `keyText` of DiscoverTags, query searches within titles, and location searches for discover items' locations.",
            parameters: [
                {
                    name: "query",
                    in: "query",
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "success" },
                                    msg: { type: "string", example: "Search results retrieved successfully." },
                                    data: {
                                        type: "object",
                                        properties: {
                                            discovers: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "error" },
                                    msg: { type: "string", example: "Search query, tags, or location are required." },
                                },
                            },
                        },
                    },
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    result: { type: "string", example: "error" },
                                    msg: { type: "string", example: "No matching tags or items found." },
                                },
                            },
                        },
                    },
