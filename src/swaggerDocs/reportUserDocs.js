                ...
                content: {
                    'application/json': {
                        schema: {
                            type: 'object',
                            properties: {
                                reportedUserId: { type: 'string', example: 'user_id_of_the_reported_user' },
                                reportReason: { type: 'string', example: 'reason_for_reporting' },
                                ...
                                "properties": {
                                    ...
                                    "data": {
                                        ...
                                        "properties": {
                                            ...
                                            "reportReason": { "type": "string", "example": "reason_for_reporting" },
                                            "details": { "type": "string", "example": "additional_details" },
                                            "reportedBy": { "type": "string", "example": "user_id_of_the_reporter" },
                        ...
                        "application/json": {
                            "schema": {
                                ...
                                "properties": {
                                    ...
                                    "msg": { "type": "string", "example": "Please provide all the required fields." },
                    ...
                    "content": {
                        "application/json": {
                            "schema": {
                                ...
                                "properties": {
                                    "result": { "type": "string", "example": "success" },
                                    "msg": { "type": "string", "example": "Reports fetched successfully." },
                                    "data": {
                                        "type": "array",
                                        "items": {
                                            "type": "object",
                    ...
                    "content": {
                        "application/json": {
                            "schema": {
                                ...
                                "properties": {
                                    "result": { "type": "string", "example": "failure" },
                                    "msg": { "type": "string", "example": "You are not authorized to view this page." },
                                    "data": { "type": "null", "example": null },
                                    "totalCount": { "type": "integer", "example": 0 }
                                }
                            }
                    ...
                    "content": {
                        "application/json": {
                            "schema": {
                                ...
                                "properties": {
                                    "result": { "type": "string", "example": "success" },
                                    "msg": { "type": "string", "example": "Report resolved successfully." },
                                    "data": { "type": "null", "example": null },
                                    "totalCount": { "type": "integer", "example": 0 }
                                }
                            }
