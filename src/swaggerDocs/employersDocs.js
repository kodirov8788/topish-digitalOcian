const EmployersEndpoint = {
    ...
    '/users/getEmployer/{id}': {
        get: {
            summary: 'Get all employer profiles',
            tags: ['Employers'],
            description: 'Endpoint to retrieve employer profile . Requires authentication.',
            parameters: [
                {
                    in: "path",
                    name: "id",
    ...
    '/users/getJobMaker/{id}': {
        get: {
            ...
            tags: ['Employers'],
            description: 'Retrieves details of an employer by their ID. Requires authentication and appropriate permissions.',
            parameters: [
                {
                    in: 'path',
                    name: 'id',
            ...
            responses: {
                    ...
                    content: {
                        'application/json': {
                            schema: {
                                ...
                                properties: {
                                    result: { type: 'string', example: 'success' },
                                    msg: { type: 'string', example: 'User retrieved successfully' },
                                    data: {
                ...
                '401': {
                    description: 'Unauthorized access, either not logged in or not permitted to access this data.',
                    content: {
                        'application/json': {
                            schema: {
                                type: 'object',
