...
const { getAllUsers, getUser, showCurrentUser, updateUserNumber, updateUserPassword, updateUserEmail, updateJobSeekerProfile, updateEmployerProfile, getRecommendedUsers, updateServiceProfile } = require("../controllers/userCTRL");
...
router.route("/getRecommendedJobSeekers").get(authMiddleware, getRecommendedUsers);
...
router.route("/getJobseekersSavedjob").get(authMiddleware, getJobSeekersSavedJobs);
router.route("/getExperiencedJobseekers").get(authMiddleware, getRecommendedJobSeekers);
router.route("/getJobSeekersQuery").get(authMiddleware, getJobSeekersQuery);
router.route("/deleteJobseekersSavedjob/:id").delete(authMiddleware, deleteSavedJob);
...
router.route("/favoriteQuickJob/:id").post(authMiddleware, postFavoriteQuickJob);
...
router.route("/getMyFavorites/:favoriteId").get(authMiddleware, GetFavoriteUser); // ALL EMPLOYERS
router
