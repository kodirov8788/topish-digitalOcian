...
const initSocketServer = (server) => {
  ...
  io.on("connection", (socket) => {
    ...
    socket.on("sendMessage", (data, callback) =>
      handleSendMessage(socket, data, io, callback)
    );
    socket.on("fileChunk", (data, callback) =>
      handleFileChunk(socket, data, callback)
    );
    socket.on("voiceChunk", (data, callback) =>
      handleVoiceChunk(socket, data, callback)
    );
    //-----------------------------------------------------------------------------------
    ...
    socket.on("deleteChatRoom", (data) =>
      handleDeleteChatRoom(socket, data, io)
    );
    ...
    socket.on("adminMessageToUser", (data) =>
      handleAdminMessageToUser(socket, data, io)
    );
