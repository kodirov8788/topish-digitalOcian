...
class ExpectedSalaryController {
  ...
  async addExpectedSalary(req, res) {
    ...
    try {
      ...
      return handleResponse(res, 201, "success", "Expected salary set", {
  ...
  async getExpectedSalary(req, res) {
    ...
    try {
      ...
      return handleResponse(res, 200, "success", "Expected salary retrieved", {
  ...
  async updateExpectedSalary(req, res) {
    ...
    try {
      ...
      return handleResponse(res, 200, "success", "Expected salary updated", {
        expectedSalary: user.resume.expectedSalary,
      });
    } catch (error) {
      return handleResponse(res, 500, "error", error.message);
  ...
  async deleteExpectedSalary(req, res) {
    ...
    try {
      ...
      return handleResponse(res, 200, "success", "Expected salary removed", {
        expectedSalary: user.resume.expectedSalary,
      });
    } catch (error) {
      return handleResponse(res, 500, "error", error.message);
