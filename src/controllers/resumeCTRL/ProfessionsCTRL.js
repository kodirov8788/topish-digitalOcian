...
class Professions {
    async addOrUpdateProfessions(req, res) {
        ...
        if (!Array.isArray(professions)) {
            return handleResponse(res, 400, "error", "Invalid or missing Professions.");
        }
        ...
        try {
            ...
            await user.save();
            handleResponse(res, 200, "success", "Professions updated", user.jobSeeker.professions, user.jobSeeker.professions.length);
        } catch (error) {
