...
class Cv {
    ...
    async addAndUpdateCvFile(req, res) {
        ...
        upload(req, res, async (err) => {
            ...
            try {
                ...
                console.error(error);
                return handleResponse(res, 500, 'error', 'An error occurred while adding/updating the CV file', null, 0);
            }
        });
    };
    ...
    async getCvFile(req, res) {
        ...
        try {
            ...
            console.error(error);
            return handleResponse(res, 500, 'error', 'An error occurred while retrieving the CV files', null, 0);
        }
    };
    ...
    async deleteCvFile(req, res) {
        ...
        try {
            ...
            return handleResponse(res, 200, 'success', 'CV deleted successfully', null, 0);
        } catch (error) {
