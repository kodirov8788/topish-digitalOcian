...
class Award {
    ...
    async addAward(req, res) {
        ...
        try {
            ...
            console.error(error);
            return handleResponse(res, 500, 'error', 'An error occurred while adding the award', null, 0);
        }
    };
    ...
    async getAwards(req, res) {
        ...
        try {
            ...
            console.error(error);
            return handleResponse(res, 500, 'error', 'An error occurred while retrieving awards', null, 0);
        }
    };
    ...
    async updateAward(req, res) {
        ...
        try {
            ...
            console.error(error);
            return handleResponse(res, 500, 'error', 'An error occurred while updating the award', null, 0);
        }
    };
    ...
    async deleteAward(req, res) {
        ...
        try {
            ...
            return handleResponse(res, 200, 'success', 'Award successfully deleted', null, 0);
        } catch (error) {
            return handleResponse(res, 500, 'error', 'An error occurred while deleting the award', null, 0);
        }
    };
}
