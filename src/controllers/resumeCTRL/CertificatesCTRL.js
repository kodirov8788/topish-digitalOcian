...
class Certificates {
    async addCertificate(req, res) {
        ...
        try {
            ...
            console.error(error);
            return handleResponse(res, 500, 'error', 'An error occurred while adding the certificate', null, 0);
        }
    };
    ...
    async updateCertificate(req, res) {
        ...
        try {
            ...
            if (certificateIndex === -1) {
                return handleResponse(res, 404, 'error', 'Certificate not found', null, 0);
            }
            ...
            console.error(error);
            return handleResponse(res, 500, 'error', 'An error occurred while updating the certificate', null, 0);
        }
    };
    ...
    async deleteCertificate(req, res) {
        ...
        try {
            ...
            return handleResponse(res, 200, 'success', 'Certificate successfully deleted', null, 0);
        } catch (error) {
            console.error(error);
            return handleResponse(res, 500, 'error', 'An error occurred while deleting the certificate', null, 0);
        }
    }
}
