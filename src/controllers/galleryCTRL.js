...
class GalleryCTRL {
    async createGalleryPost(req, res) {
        try {
            ...
            if (!user || !user.jobSeeker) {
                return handleResponse(res, 401, 'error', 'User not found or jobSeeker property missing', null, 0);
            }
            ...
            upload(req, res, async (err) => {
                ...
                return handleResponse(res, 200, 'success', 'Gallery post updated successfully', gallery, 1);
            });
        } catch (error) {
    ...
    async getAllMyGalleryPost(req, res) {
        try {
            ...
            if (galleryPosts.length === 0) {
                return handleResponse(res, 200, 'error', 'Gallery posts not found', {}, 0);
            }
    ...
    async getGalleryPost(req, res) {
        try {
            ...
            if (!galleryPost) {
                return handleResponse(res, 404, 'error', 'Gallery post not found', null, 0);
            }
