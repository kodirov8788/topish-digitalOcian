...
//             bot.sendMessage(msg.chat.id, 'Bu telegram oldin ro\'yxatdan o\'tgan, iltimos boshqa telegramni ulang yoki admin bilan bog\'laning');
//         } else if (error.response && error.response.status === 407) {
//             bot.sendMessage(msg.chat.id, 'Bu telefon raqam oldin ro\'yxatdan o\'tgan, iltimos boshqa raqamni ulang yoki admin bilan bog\'laning');
//         } else {
